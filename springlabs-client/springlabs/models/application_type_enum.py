...
class ApplicationTypeEnum(object):
    ...
    allowable_values = [APPLICATION, ASSESSMENT]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ApplicationTypeEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ApplicationTypeEnum):
            return False
